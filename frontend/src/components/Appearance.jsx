...
// Body faces only: mono stacks stay out of the picker (they made notes read
// like source; code chrome keeps Fira Code internally), and thin garalde
// faces like Cormorant Garamond dropped for legibility at body sizes
const FONT_OPTIONS = [
  { value: 'Lora, Georgia, serif', label: 'Lora', group: 'Literary' },
  { value: 'Georgia, serif', label: 'Georgia', group: 'Literary' },
  { value: '"EB Garamond", Georgia, serif', label: 'EB Garamond', group: 'Literary' },
  { value: 'Literata, Georgia, serif', label: 'Literata', group: 'Literary' },
  { value: '"IM Fell English", Georgia, serif', label: 'IM Fell English', group: 'Literary' },
  { value: "'Fraunces Variable', Georgia, serif", label: 'Fraunces', group: 'Literary' },
]
