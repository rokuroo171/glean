...
const gleanTheme = EditorView.theme({
  ...
  '.glean-hide': { color: 'transparent !important', opacity: 0, pointerEvents: 'none', background: 'transparent !important' },
  ...
  '.glean-callout-title': {
    display: 'inline-flex', alignItems: 'center', fontWeight: 700, fontSize: '0.95em', paddingTop: '6px',
  },
  '.glean-callout-icon': { marginRight: '6px', fontSize: '1.1em' },
  '.glean-callout': {
    backgroundColor: 'rgba(55,130,200,0.10)', borderLeft: '3px solid #3388cc',
    paddingLeft: '10px', marginLeft: '0', paddingBottom: '2px',
  },
